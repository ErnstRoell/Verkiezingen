...
from .visuals import init_color_function, init_size_function, init_type_function, format_meta, format_mapper_data, build_histogram, graph_data_distribution
...
class KeplerMapper(object):
    ...
    def visualize(self,
        ...
        color_function = init_color_function(color_function)
        size_function = init_size_function(size_function)
        type_function = init_type_function(type_function)

        mapper_data = format_mapper_data(graph, color_function, size_function, type_function, X,
                                         X_names, lens,
